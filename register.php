        ...
        <form action="" method="post">
            <fieldset id="first">
                <div>
                    ...
                    <p style="margin-top: 30px; color: whitesmoke;">Do you have an account ?</p>
                    <button type="button" class="btn btn-primary logInButton" style="width: 100px; height: 40px;">LOG IN</button>
                </div>
            </fieldset>
<!-- 
        </form> -->
            ...
            <fieldset id="second">
               <div>
                    ...
                    <h1>Personal Data</h1>
                    <div class="form-row">
                        <input type="text" name="imie" placeholder="FIRST NAME">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" fill="whitesmoke" class="bi bi-person-fill" viewBox="0 0 16 16">
                            <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/>
                        </svg>
                    </div>
                    ...
                    <div class="form-row">
                        <input type="text" name="nazwisko" placeholder="LAST NAME">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" fill="whitesmoke" class="bi bi-lock-fill" viewBox="0 0 16 16">
                            <path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"/>
                        </svg>
                    </div>
                    ...
                    <button type="submit" id="submit" class="btn btn-secondary" style="margin-top: 20px;"> Register </button>
    ...
    <?php
        ...
        if(isset($_POST['login']) && isset($_POST['password']) && isset($_POST['email']) && isset($_POST['imie']) && isset($_POST['nazwisko']) && isset($_POST['date'])){
            ...
            if(!empty($login) && !empty($password) && !empty($email) && !empty($imie) && !empty($nazwisko) && !empty($urodziny)){
                ...
                $query2 = "SELECT login FROM users WHERE login='{$login}' OR email='{$email}'";
                $res2 = mysqli_query($connection,$query2);

                if(mysqli_num_rows($res2) >= 1){
                    echo "<div class='alert alert-danger' role='alert'>
                    Login or Password are already used
                    </div>";
                    exit();
                }

                $query = "INSERT INTO users (first_name,last_name,email,login,password,birthday) VALUES ('{$imie}','{$nazwisko}','{$email}','{$login}','{$password}','{$urodziny}')";
